...
async function exportFilteredDataXLSX() {
  ...
  totalsRow.eachCell((cell, colNumber) => {
    ...
    cell.border = {
      top: { style: "medium", color: { argb: "FFF54927" } },
      bottom: { style: "medium", color: { argb: "FFF54927" } },
  ...
  signatureRow.eachCell((cell) => {
    ...
    cell.alignment = { horizontal: "center", vertical: "center" };
    cell.border = {
      top: { style: "thin", color: { argb: "FFF54927" } },
      bottom: { style: "thin", color: { argb: "FFF54927" } },
      left: { style: "thin", color: { argb: "FFF54927" } },
      right: { style: "thin", color: { argb: "FFF54927" } },
    };
  });
